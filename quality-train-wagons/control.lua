...
local rescan_artillery_wagon = function(surface)
    local name = "artillery-wagon"
    for _, wagon in pairs(surface.find_entities_filtered { name = name }) do
        ...
        local wagon_inventory = wagon.get_inventory(defines.inventory.artillery_wagon)
        ...
        local quality_wagon_inventory = quality_wagon.get_inventory(defines.inventory.artillery_wagon)
